...
module.exports.Welcome = (firstName) => {
  return `
        <p>Hi ${firstName}, </p>
        <p>Thank you for signing up VisiMark! Do send me an email to:
        <a href="mailto:VisiMark@gmail.com">VisiMark@gmail.com</a></p>
...
module.exports.KickStudent = (firstName, payload) => {
  return `
        <p>Hi ${firstName}, </p>
        <p>
          Course owner had removed you out from the course below. 
        </p>
